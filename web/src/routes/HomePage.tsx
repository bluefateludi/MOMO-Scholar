...
export function HomePage() {
  ...
  return <>
    <section className="tech-hero"><div><p className="eyebrow">v0.1 · Bounded component research</p><h1>Choose with<br/><em>receipts.</em></h1><p className="dek">Compare Python AI components against hard constraints, traceable evidence, and deterministic allowlisted checks.</p></div><aside className="scope-card"><b>Execution boundary</b><strong>Local RAG vector stores</strong><p>Fast Demo is synthetic and offline. Verified covers only the bounded Hero Case and depends on provider/cache, Docker, and an enforced install network.</p></aside></section>
